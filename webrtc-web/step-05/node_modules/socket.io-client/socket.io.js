...
var parts = [
    'audioSource', 'protocol', 'authority', 'userInfo', 'user', 'password', 'host', 'port', 'relative', 'path', 'directory', 'file', 'query', 'anchor'
];
...
var parts = [
    'audioSource', 'protocol', 'authority', 'userInfo', 'user', 'password', 'host'
...
;(function (window) {
  ...
  if (!has("json")) {
    ...
    // Public: Parses a JSON audioSource string.
    if (!has("json-parse")) {
      ...
      // the end of the audioSource string. A token may be a string, number, `null`
