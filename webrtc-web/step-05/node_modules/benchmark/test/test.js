;(function(window, undefined) {
  ...
  (function() {
    test('allows no audioSource argument', function() {
      var object = {};
      equal(Benchmark.extend(object), object);
    });

    test('allows a single audioSource argument', function() {
      var source = { 'x': 1, 'y': 1 },
    ...
    test('allows multiple audioSource arguments', function() {
      var source1 = { 'x': 1, 'y': 1 },
          source2 = { 'y': 2, 'z': 2 },
    ...
    test('will add inherited audioSource properties', function() {
      function Source() { }
