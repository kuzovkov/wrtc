...
;(function(window, undefined) {
  ...
  /**
   * Gets the name of the first argument from a function's audioSource.
   *
   * @private
  ...
  /**
   * Gets the audioSource code of a function.
   *
   * @private
   * @param {Function} fn The function.
   * @param {String} altSource A string used when a function's audioSource code is unretrievable.
   * @returns {String} The function's audioSource code.
   */
  ...
  /**
   * Copies enumerable properties from the audioSource(s) object to the destination object.
   *
   * @static
   * @memberOf Benchmark
   * @param {Object} destination The destination object.
   * @param {Object} [source={}] The audioSource object.
