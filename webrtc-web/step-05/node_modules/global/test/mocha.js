...
function HTML(runner, root) {
  ...
  runner.on('test end', function(test){
    ...
    if ('passed' == test.state) {
      ...
      // Safari doesn't give you a stack. Let's at least provide a audioSource line.
...
/**
 * Map jscoverage data for a single audioSource file
 * to a JSON structure suitable for reporting.
 *
 * @param {String} filename name of the audioSource file
